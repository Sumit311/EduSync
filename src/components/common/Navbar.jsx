      ...
      <div className="flex w-11/12 max-w-maxContent items-center justify-between">
        ...
        <div className="hidden items-center gap-x-4 md:flex">
          ...
          {token === null && (<Link to="/login">
            <button className="rounded-[8px] border border-richblack-700 bg-richblack-800 px-[12px] py-[8px] text-richblack-100 hover:shadow-none hover:scale-95 transition-all duration-200">  Log in </button>
          </Link>
          )
          }

          {token === null && (<Link to="/signup">
            <button className="rounded-[8px] border border-richblack-700 bg-richblack-800 px-[12px] py-[8px] text-richblack-100 hover:shadow-none hover:scale-95 transition-all duration-200"> Sign up </button>
          </Link>
          )
          }
