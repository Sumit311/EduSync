          ...
          <div className="lg:w-[50%] flex flex-wrap flex-row justify-between lg:border-r lg:border-richblack-700 pl-3 lg:pr-5 gap-3">
            ...
            <div className="w-[30%] flex flex-col gap-3 lg:w-[30%] mb-7 lg:pl-0">
              ...
              <div className="flex gap-3 text-lg">
                <FaFacebook className="cursor-pointer hover:text-richblack-50 transition-all duration-200" /> <FaGoogle className="cursor-pointer hover:text-richblack-50 transition-all duration-200" /> <FaTwitter className="cursor-pointer hover:text-richblack-50 transition-all duration-200" />  <FaYoutube className="cursor-pointer hover:text-richblack-50 transition-all duration-200" />
              </div>
